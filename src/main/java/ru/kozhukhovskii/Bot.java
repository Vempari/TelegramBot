...
public class Bot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update e) {
        ...
        if (text.equals("/start")) {
            try {
                sendMessage.setText("Привет! Я тестовый бот и я предаставляю доступ к файлам для обучающихся по курсу Java.\n" +
                        "Если хочешь посмотреть рассписание уроков напиши 'Расписание' \n" +
    ...
    private String getMessage(String text, Message message) {
        ...
        switch (text) {
            case "Меню":
                ...
                return "Выбери";
            case "Расписание":
                File file = new File("src/main/resources/Расписание занятий.pdf");
            ...
            case "Лекции":
                ...
                leftRow.add("4. Массивы. Операторы и структура кода. Исключения.");
                ...
                rightRow.add("7. ClassLoaders.");
                rightRow.add("8. Введение в сетевые протоколы. Пакет java.io и работа с ресурсами.");
                thirdRow.add("9. Потоки выполнения. Синхронизация. Часть 1.");
                thirdRow.add("10. Потоки выполнения. Синхронизация. Часть 2.");
                thirdRow.add("11. Stream API и лямбда выражения.");
                thirdRow.add("12. Основы Java EE. UML");
                fourthRow.add("13. JVM, JIT, GC.");
                fourthRow.add("14. Инструменты сборки");
                fourthRow.add("15. Модульное тестирование на базе Junit 5. Часть 1.");
                fourthRow.add("16. Модульное тестирование на базе Junit 5. Часть 2");
                fourthRow.add("Меню");
